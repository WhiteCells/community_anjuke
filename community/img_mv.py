...
bg_path = "./verify_img/img_1_1.jpg"
target_path = "./verify_img/img_1_2.jpg"

if not os.path.exists(bg_path):
    print(f"Error: {bg_path} 不存在或路径错误")
if not os.path.exists(target_path):
    print(f"Error: {target_path} 不存在或路径错误")


# 加载背景图像
bg = cv2.imread("./verify_img/img_1_1.jpg")
# 检查图像是否成功加载
if bg is None:
...
# 加载目标图像
target = cv2.imread("./verify_img/img_1_2.jpg")
# 检查图像是否成功加载
if target is None:
